        ...
        Widget check(String label) => Padding(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(label, style: TextStyle(fontSize: 13, color: t.textPrimary)),
                  ),
                ],
              ),
            );
  ...
  Widget build(BuildContext context) {
    ...
    return CSScaffold(
      ...
      body: SingleChildScrollView(
        ...
        padding:
            const EdgeInsets.symmetric(horizontal: AppSpacing.pageMargin, vertical: 20),
        child: Form(
          key: _formKey,
          child: Column(
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: Icon(Iconsax.shield_tick, color: t.accent, size: 20),
                        ),
