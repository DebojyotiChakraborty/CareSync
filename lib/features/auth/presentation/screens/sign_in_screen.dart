...
class _SignInScreenState extends ConsumerState<SignInScreen> {
  ...
  Future<void> _show2FASheet(SignInResult result) async {
    // Show sheet to choose 2FA method
    final method = await showAppSheet<TwoFactorCodeType>(
      context,
      builder: (ctx) => AppSheetContent(
        ...
        children: [
          CSPrimaryButton(
            label: 'Email Code',
            icon: Iconsax.sms,
            onPressed: () => Navigator.pop(ctx, TwoFactorCodeType.email),
          ),
