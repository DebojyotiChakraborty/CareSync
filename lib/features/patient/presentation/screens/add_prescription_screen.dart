...
class _AddPrescriptionScreenState extends ConsumerState<AddPrescriptionScreen> {
      ...
      setState(() {
        ...
        if (prescriptionData.doctorName != null ||
          ...
          _doctorDetails = _doctorDetails.copyWith(
            ...
            hospitalClinicName: prescriptionData.hospitalName ??
                      ...
                      if (_medications.isEmpty)
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Icon(Iconsax.box, size: 16, color: t.textSecondary),
  ...
  InputDecoration _inputDecoration(
    ...
    return InputDecoration(
      ...
      labelStyle: TextStyle(
          fontSize: 13, fontWeight: FontWeight.w500, color: t.textSecondary),
      hintText: hint,
  ...
  Widget _buildSafetyFlags() {
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _buildSafetyCheckTile('ALLERGIES DETECTED?', _allergiesMentioned,
        ...
        Divider(height: 24, color: t.divider),
        _buildSafetyCheckTile('CHRONIC CONDITION LINK?', _chronicConditionLinked,
  ...
  Widget _buildRadioBtn(
      bool optionVal, bool? currentVal, Function(bool?) onChanged, String label) {
    final t = context.tokens;
