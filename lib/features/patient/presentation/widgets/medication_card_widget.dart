...
class _MedicationCardWidgetState extends State<MedicationCardWidget> {
  ...
  void initState() {
    super.initState();
    _nameController =
        TextEditingController(text: widget.initialData?.medicineName);
    ...
    _selectedFrequency =
        (initialFrequency != null && frequencyMap.containsKey(initialFrequency))
            ...
            : null;
    _durationController =
        TextEditingController(text: widget.initialData?.duration);
  ...
  InputDecoration _inputDecoration(
    ...
    return InputDecoration(
      ...
      labelStyle: TextStyle(
          fontSize: 12, fontWeight: FontWeight.w500, color: t.textSecondary),
      hintText: hint,
