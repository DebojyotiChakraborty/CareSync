...
class _EmergencyAccessHistoryScreenState
        ...
        data: (logs) {
          final filteredLogs = logs.where((log) {
            ...
            if (search.isNotEmpty) {
              ...
              final uid =
                  (log['accessed_by_user_id'] as String? ?? '').toLowerCase();
  ...
  Widget _buildAnalyticsSection(List<Map<String, dynamic>> logs) {
    ...
    int failedCount = logs
        .where((l) =>
            l['access_status'] == 'Failed' || l['access_status'] == 'Denied')
        .length;
    int suspiciousCount =
    ...
    int faceCount = logs
        ...
        .length;
    int overrideCount = logs
        .where((l) =>
            l['authentication_method'] == 'Manual Emergency Override')
        .length;
    ...
    return SizedBox(
      ...
      child: Padding(
        ...
        child: ListView(
          ...
          children: [
            _buildStatCard('Total Accesses', totalAccesses.toString(),
                '30 Days', t.accent, Iconsax.security),
            _buildStatCard('Failed Attempts', failedCount.toString(),
                'Denied access', t.error, Iconsax.warning_2),
            _buildStatCard('Suspicious Alerts', suspiciousCount.toString(),
                'Anomalies flagged', t.accent, Iconsax.shield_search),
            _buildStatCard('QR Scans', qrCount.toString(), 'Quick lookup',
                t.accent, Iconsax.scan),
            _buildStatCard('Biometrics Match', faceCount.toString(),
                'Face recognition', t.accent, Iconsax.frame_1),
            _buildStatCard('Emergency Override', overrideCount.toString(),
                'Manual override', t.accent, Iconsax.lock_slash),
          ],
        ),
      ),
    );
      ...
      children: [
        Text(
          ...
          style: t.monoMeta.copyWith(
              fontSize: 8, fontWeight: FontWeight.w700, color: t.textSecondary),
        ),
  ...
  Widget _buildAuditLogCard(Map<String, dynamic> log) {
    ...
    final location = [log['city'], log['state']]
        .where((e) => e != null && e != 'Unknown')
        .join(', ');
                    ...
                    Row(
                      children: [
                        Icon(Iconsax.location,
                            size: 10.5, color: t.textSecondary),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ...anomaly['reasons'].map<Widget>((reason) =>
                                Padding(
                                  padding:
