...
class _EmergencyAccessScreenState extends ConsumerState<EmergencyAccessScreen> {
  ...
  Future<void> _requestAccess() async {
    ...
    try {
      final accessId =
          await EmergencyAccessService.instance.requestEmergencyAccess(
            ...
            SquircleCard(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildDetailRow(Iconsax.finger_scan, 'Authentication',
                      'Biometric required'),
                  _buildDetailRow(Iconsax.document_text, 'Audit', 'Fully logged'),
                  _buildDetailRow(
                      Iconsax.notification, 'Patient', 'Will be notified'),
                ],
              ),
            ),
            const SizedBox(height: 32),
