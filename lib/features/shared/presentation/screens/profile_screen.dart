...
class ProfileScreen extends ConsumerWidget {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(isVerified ? Iconsax.verify : Iconsax.warning_2,
                color: color, size: 12),
      ...
      child: Column(
        children: [
          ...
          _buildSettingsTile(
            context,
            icon: Iconsax.edit_2,
            title: signatureAsync.valueOrNull != null
  ...
  Widget _buildSettingsTile(
    ...
    return Column(
      children: [
        ...
        if (!isDestructive)
          Divider(height: 1, indent: 60, color: t.divider),
      ],
    );
  }
  ...
  void _showEditPharmacistProfile(
    ...
    final addressController =
        TextEditingController(text: profile.pharmacyAddress);
  ...
  void _showSignaturePadSheet(BuildContext context, WidgetRef ref) {
    showAppSheet<void>(
      context,
      builder: (ctx) => _SignatureSheet(ref: ref),
    );
  }
}
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      if (byteData != null) {
        ...
        if (userId != null) {
          await SupabaseService.instance.client.from('doctors').update({
